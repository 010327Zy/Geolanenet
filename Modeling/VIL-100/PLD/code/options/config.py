...
class Config(object):
    ...
    def setting_for_path(self):
        ...
        self.dir['pre2'] = f'{self.dir["head_pre"]}/P02_SVD/output_train/pickle'
        self.dir['pre3_train'] = f'{self.dir["head_pre"]}/P03_video_based_datalist/output_train/pickle'
        self.dir['pre3_test'] = f'{self.dir["head_pre"]}/P03_video_based_datalist/output_test/pickle'
        self.dir['model1'] = f'{os.path.dirname(os.path.dirname(self.dir["proj"]))}/ILD_seg/out_sppool_1'
        self.dir['model2'] = f'{os.path.dirname(os.path.dirname(self.dir["proj"]))}/ILD_coeff/out_sppool_1_squriouloss_3'#####
    ...
    def setting_for_dataset_path(self):
        self.dataset_name = 'vil100'  # ['tusimple', 'vil100']
