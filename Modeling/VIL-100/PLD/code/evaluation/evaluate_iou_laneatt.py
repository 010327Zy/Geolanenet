...
def culane_metric(pred, anno, shape, width=30, iou_threshold=0.5, official=False, img_shape=(590, 1640, 3)):
    if len(pred) == 0:
...
class LaneEval_CULane_LaneATT(object):
    ...
    def settings(self, test_mode, iou):
        ...
        self.anno_dir = f'{self.cfg.dir["dataset"]}/anno_txt/'
    ...
    def eval_predictions(self):
        ...
        # img_shape = (self.cfg.height, self.cfg.width, 3)
